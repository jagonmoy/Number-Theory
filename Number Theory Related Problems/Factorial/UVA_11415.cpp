...
int main() {
    ...
    cin.tie(0);
    sieve(10000000);
    precalculating_number_of_factors_1_to_n_factorial(10000000);
    ll t ;
    scanf("%lld",&t);
    while(t--) {
        ll n ;
        scanf("%lld",&n);
        ll up = upper_bound( no_of_factors+1,  no_of_factors+10000001, n) -  no_of_factors;
        printf("%lld\n",up);
    }
